...
8 is the number of aligner threads used by bwa-mem. We also see a limitation of the mpi_read_at fonction the buffer 
 is limited at 2g. 

Remark: This version does not work on trimmed reads. 
