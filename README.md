...
Release 1.0 from 02/04/2018  <br />

Update and changes in Experimental branch <br />

1) Now mpiBWA support trimmed reads or reads of different length.<br />
2) Be aware of the flock on Lustre and Beegfs. The flock must be on otherwise could be problem with reproducibility.<br />

Thanks to Romain Brisse for helping me.
